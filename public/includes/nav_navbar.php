  ...
  <div>
    ...
    <div class="dropdown">
      ...
      <div class="dropdown-menu">
        ...
        <a href="<?php echo URL; ?>positions" class="dropdown-item <?php echo $current_page == 'positions' ? 'active' : ''; ?>">Position</a>
        <a href="<?php echo URL; ?>departments" class="dropdown-item <?php echo $current_page == 'departments' ? 'active' : ''; ?>">Department</a>
      </div>
    </div>
  </div>
